...
from evals.evaluators.reco_evaluator import RecoEvaluator
...
저는 [관계]로서 {inputs.requester_name}님을 [기간]동안 함께 일하며 지켜본 {inputs.recommender_name}입니다...

[본문 문단들...]

위와 같은 이유로 {inputs.requester_name}님을 적극 추천합니다...
